...
public:
  ...
  void setMaxThrottle(double t);
  unsigned int getThrottle(){return myThrottle;};
  unsigned int getMaxThrottle(){return myMaxThrottle;};  
protected:
  void activate(void);
